...
# números inteiros e escreva na
# saída esses números em ordem decrescente.
...
.text 
	...
	for2:
		...
		addi $sp, $sp, 4
		bne $t7, $zero, for2
		addi $t9, $t9, -1 # decremento do contador de i
		mul $t5, $t9, -4
		add $sp, $zero, $t5
		bne $t9, $zero, for1 # se o i == 0, terminou de percorrer a pilha
		j exit_loop
	...
	troca:
		...
		add $t4, $t2, $zero
		add $t2, $t3, $zero
		# registradores trocados, falta trocar na memória
		mul $t5, $t9, -4
		add $sp, $zero, $t5
