# Dados dois vetores x e y, ambos com n
# elementos, determinar o produto escalar
# desses vetores.

.data
	entrada1: .asciiz "Quantos elementos tem os vetores X e Y? "
	pede_vet_x: .asciiz "Entre com os elementos do vetor X:\n"
	pede_vet_y: .asciiz "Entre com os elementos do vetor Y:\n"
	pede_elemento: .asciiz "Elemento "
	resultado: .asciiz "\nProduto escalar X * Y = "
	dois_pontos: .asciiz ": "
	virgula: .asciiz ","
	vetor: .asciiz "Vetor: "
...
.text
	main:	# main program entry
		...
		# Solicita o vetor X
		la $a0, pede_vet_x	# Carrega a mensagem solicitando o vetor X
		...
		# Solicita o vetor Y
		la $a0, pede_vet_y	# Carrega a mensagem solicitando o vetor Y
		li $v0, 4		# Código para escrever uma string na tela
		syscall
	...
	ler_vetor:
		...
		loop:
			...
			la $a0, pede_elemento	# Carrega a primeira parte da msg solicitando o elemento
			li $v0, 4 		# Código para imprimir uma string na tela
			syscall
			addi $t1, $t0, 1	# $t1 = i + 1
			...
			syscall
			la $a0, dois_pontos	# Carrega a parte final da msg a ser impressa
			li $v0, 4		# Código para imprimir uma string na tela
			syscall
